...
class Window(QWidget):
  def __init__(self):
    ...
    # QSS
    date = ""
    with open(Config.BLFRPQSS_PATH,"r") as BLFRP_QSS:
      date += BLFRP_QSS.read()
    with open(Config.NavigationBarQSS_PATH,"r") as NavigationBar_QSS:
      self.NavigationBar_date = NavigationBar_QSS.read()
    with open(Config.Logon_QwidgetQSS_PATH,"r") as Logon_Qwidget_QSS:
      self.Logon_Qwidget_date = Logon_Qwidget_QSS.read()
    ...
    self.Label_WedsiteAnnouncement = QLabel("网站公告",self.Announcement_QFrame)
    self.Label_WedsiteAnnouncement.setObjectName("h1")
    self.Label_WedsiteAnnouncement.setGeometry(20,10,200,30)
    self.Label_WedsiteAnnouncement_1 = QLabel(Tools.Fetch_Announcement(),self.Announcement_QFrame)
    self.Label_WedsiteAnnouncement_1.setObjectName("h2")
    self.Label_WedsiteAnnouncement_1.setGeometry(20,40,680,200)
    ...
    self.Label_Log.setGeometry(32,10,100,30)
    self.Label_development = QLabel("正在开发中,敬请期待...",self.Log_QWidget)
    self.Label_development.setObjectName("h2")
    self.Label_development.setGeometry(32,50,200,30)
    ...
    if (Tools.logon_status()):
      ...
      self.Button_SignOutLogin.clicked.connect(lambda: Tools.Remove_User())
    else:
  ...
  def NavigationBar_Gui(self):
    ...
    if (Tools.logon_status() == False):
      self.Button_Tunnel.setDisabled(True)
  ...
  def Logon(self):
    ...
    if (Tools.Determine_The_Tonken(key)):
      ...
      self.LogonTrue_QWidget.setWindowIcon(QtGui.QIcon(QtGui.QPixmap(Config.BLFRPIcon)))
      self.LogonTrue_QWidget.setWindowOpacity(0.95)
      self.LogonTrue_QWidget.setWindowTitle("登录成功")
      self.LogonTrue_QWidget.setObjectName("Logon_QWidget")
      self.LogonTrue_QWidget.resize(300,150)
      self.Label_Logon = QLabel("登录成功,正在刷新页面中...",self.LogonTrue_QWidget)
      self.Label_Logon.setObjectName("h1")
      self.Label_Logon.setGeometry(10,20,280,100)
      self.LogonTrue_QWidget.show()
